"""
Django settings for chivstats project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                #'leaderboards.context_processors.leaderboard_names',
            ],
        },
    },
]

WSGI_APPLICATION = 'chivstats.wsgi.application'
